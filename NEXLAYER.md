...
**Live:** [https://relaxed-weasel-espocrm.cloud.nexlayer.ai](https://relaxed-weasel-espocrm.cloud.nexlayer.ai)  
...
**espocrm** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
  - name: app
    image: mirror.gcr.io/espocrm/espocrm:latest
    path: /
    servicePorts:
    - 80
    vars:
      ESPOCRM_DATABASE_HOST: mysql.pod
      ESPOCRM_DATABASE_NAME: espocrm
      ESPOCRM_DATABASE_USER: espocrm
      ESPOCRM_DATABASE_PASSWORD: espocrm
      ESPOCRM_SITE_URL: "https://relaxed-weasel-espocrm.cloud.nexlayer.ai"
